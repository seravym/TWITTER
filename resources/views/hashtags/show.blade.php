...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .post-content { font-size: 1.1em; line-height: 1.65; color: #0f1419; margin-bottom: 15px; }
        ...
        .post-actions { display: flex; gap: 10px; border-top: 1px solid #eff3f4; padding-top: 14px; }
        .action-btn {
